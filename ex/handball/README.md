# Handball
  ...
  * [OpenAlex API / priročnik](https://developers.openalex.org/guides/searching)
  * Openalex vrstične poizvedbe
    * https://api.openalex.org/works?search.exact="handball*"
    * https://api.openalex.org/works?search.title_and_abstract=handball&page=1&sort=relevance_score:desc
