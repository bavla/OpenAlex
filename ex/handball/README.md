# Handball
  ...
  * https://api.openalex.org/works/W2083084326?select=id,title,publication_year,countries_distinct_count,cited_by_count,referenced_works_count,biblio,type,authorships
